...
public class DsEventController extends GeneralController<DsEvent>{
	...
	@Override
	@RequestMapping("Add")
	public Object add(@RequestBody DsEvent model) throws Exception {
	...
	public Object update(@RequestBody DsEvent model) throws Exception {
		// TODO Auto-generated method stub
