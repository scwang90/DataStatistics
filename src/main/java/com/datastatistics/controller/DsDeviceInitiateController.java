...
/**
 * 数据库表ds_device_initiate 的Controller层实现
 * @author 树朾
 * @date 2015-07-29 22:55:47 中国标准时间
 */
@RestController
@Intent("数据库表ds_device_initiate")
@RequestMapping("DsDeviceInitiate")
public class DsDeviceInitiateController extends GeneralController<DsDeviceInitiate>{

	@Autowired
	DsDeviceInitiateService service;
	...
	@Override
	@RequestMapping("Add")
	public Object add(@RequestBody DsDeviceInitiate model) throws Exception {
	...
	public Object update(@RequestBody DsDeviceInitiate model) throws Exception {
		// TODO Auto-generated method stub
