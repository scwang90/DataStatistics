...
public class DsFeedbackController extends GeneralController<DsFeedback>{
	...
	@Override
	@RequestMapping("Add")
	public Object add(@RequestBody DsFeedback model) throws Exception {
	...
	public Object update(@RequestBody DsFeedback model) throws Exception {
		// TODO Auto-generated method stub
