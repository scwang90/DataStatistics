...
public class DsExceptionalController extends GeneralController<DsExceptional>{
	...
	@Override
	@RequestMapping("Add")
	public Object add(@RequestBody DsExceptional model) throws Exception {
	...
	public Object update(@RequestBody DsExceptional model) throws Exception {
		// TODO Auto-generated method stub
