...
/**
 * 数据库表ds_application 的Controller层实现
 * @author 树朾
 * @date 2015-07-28 23:44:10 中国标准时间
 */
@RestController
@Intent("数据库表ds_application")
@RequestMapping("DsApplication")
public class DsApplicationController extends GeneralController<DsApplication>{

	@Autowired
	DsApplicationService service;
	...
	@Override
	@RequestMapping("Add")
	public Object add(@RequestBody DsApplication model) throws Exception {
	...
	public Object update(@RequestBody DsApplication model) throws Exception {
		// TODO Auto-generated method stub
