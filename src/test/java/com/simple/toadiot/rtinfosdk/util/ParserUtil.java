...
package com.simple.toadiot.rtinfosdk.util;
...
import com.simple.toadiot.rtinfosdk.util.exception.ParseFromObjectException;
...
public class ParserUtil {
	...
	public static  String toJson(Object model) {
		...
		try {
			...
			throw new ParseFromObjectException("Cannot parse model to object",
					e);
		}
	...
	public static <T> List<T> toConnectedObjects(
		...
		try {
			...
			throw new ParseToObjectException(String.format(
	...
	public static <T> T toConnectedObject(String body,
			Class<T> clazz) {
